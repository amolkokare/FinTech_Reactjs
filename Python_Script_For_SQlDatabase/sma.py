...
for index,sym in Symbol.itertuples():
     ...
     smadata = (data[['SYMBOL', 'TIMESTAMP1', 'CLOSE1', 'sma05', 'sma10','sma20', 'sma50', 'sma200','WEEKHIGH','WEEKLOW','Percentage_change','Avg_Price_5days','Avg_Vol_20day','Relative_Volume','Away_52WeekHigh','Away_52WeekLow']])

     df=pd.DataFrame(smadata)
     smadata.to_csv("testdata1115551.csv")
     print(df)

     columns=['SYMBOL','CLOSE1','TIMESTAMP1','sma05','sma10','sma20','sma50','sma200','WEEKHIGH','WEEKLOW','Percentage_change','Avg_Price_5days','Avg_Vol_20day','Relative_Volume','Away_52WeekHigh','Away_52WeekLow']
     ...
     sql_insert='''INSERT INTO NSEDATA.dbo.NSEAnalysisData(SYMBOL,CLOSE1,TIMESTAMP1,sma05,sma10,sma20,sma50,sma200,WEEKHIGH,WEEKLOW,Percentage_change,Avg_Price_5days,Avg_Vol_20day,Relative_Volume,Away_52WeekHigh,Away_52WeekLow)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)'''
